...
def patientSearchCriteria():
    ...
    lower(name) LIKE '%" + searchCriteria.lower() + "%' order by userId desc limit 10")"""
        with sqlite3.connect('patient.db') as conn:
            ...
            c.execute("SELECT * FROM patients WHERE fname = ?",(searchCriteria,))
    ...
    lower(name) LIKE '%" + searchCriteria.lower() + "%' order by userId desc limit 10")"""
        with sqlite3.connect('patient.db') as conn:
            ...
            c.execute("SELECT * FROM patients WHERE lname = ?",(searchCriteria,))
            searchResults = c.fetchall()
        ...
        with sqlite3.connect('patient.db') as conn:
            ...
            c.execute("SELECT * FROM patients WHERE gender = ?",(searchCriteria,))
            searchResults = c.fetchall()
    ...
    lower(name) LIKE '%" + searchCriteria.lower() + "%' order by userId desc limit 10")"""
        with sqlite3.connect('patient.db') as conn:
            ...
            c.execute("SELECT * FROM patients WHERE dob = ?",(searchCriteria,))
            searchResults = c.fetchall()
